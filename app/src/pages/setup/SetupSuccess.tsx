      ...
      >
        <div className="p-12 text-center">
          ...
          <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-6 mb-8 text-left">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[#4F46E5] text-white flex items-center justify-center flex-shrink-0 text-sm font-medium">
                  1
                </div>
                <div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-[#4F46E5] text-white rounded-lg hover:bg-[#6366F1] transition-colors font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
          >
            Go to Dashboard
